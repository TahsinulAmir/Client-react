...
const AjukanPinjam = () => {
    ...
    const addData = async (data) => {
        try {
            const response = await axios.post('http://127.0.0.1:8000/api/pengajuan', data);
                        ...
                        <form className='container mt-3' onSubmit={handleSubmit}>
                            ...
                            <div className="mb-3 row">
                                ...
                                <div className="col-sm-9">
                                    ...
                                    {/* <input type="text" className="form-control" id="prodi" name="prodi" required /> */}
                                </div>
                            </div>
                            <div className="mb-3 row">
                            ...
                            <div className="mb-3 row">
                                ...
                                <div className="col-sm-9">
                                    ...
                                    {/* <input type="text" className="form-control" id="angkatan" name="angkatan" required /> */}
                                </div>
                            </div>
                            <div className="mb-3 row">
                            ...
                            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                <button class="btn btn-primary me-md-2" type="submit">Add Data</button>
